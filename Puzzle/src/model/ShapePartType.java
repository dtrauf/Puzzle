...
public enum ShapePartType {
	...
	UPPER_GAP_FILLED("data/shapes/shape06.png"),
	RIGHT_GAP_FILLED("data/shapes/shape07.png"),
	LOWER_GAP_FILLED("data/shapes/shape08.png"),
	LEFT_GAP_FILLED("data/shapes/shape09.png");	
